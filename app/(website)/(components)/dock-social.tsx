...
const DATA = {
  contact: {
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/ritikchhipa5/",
        icon: Icons.linkedin,
      },
      X: {
        name: "X",
        url: "https://x.com/Ritikchhipa5",
        icon: Icons.x,
      },
      Instagram: {
        name: "Instagram",
        url: "https://www.instagram.com/chhiparitik5",
        icon: Icons.instagram,
      },

      Telegram: {
        name: "Telegram",
        url: "https://t.me/Ritikchhipa5",
        icon: Icons.telegram,
      },
      Upwork: {
        name: "Upwork",
        url: "https://www.upwork.com/freelancers/~01567a14a1df3e84cd",
        icon: Icons.upwork,
      },
      Fiverr: {
        name: "Fiverr",
        url: "https://www.fiverr.com/rit9001586400",
        icon: Icons.fiverr,
      },
    },
  },
...
export function DockSocial() {
  return (
    <TooltipProvider>
      <Dock direction="middle" className="mx-0  border-0">

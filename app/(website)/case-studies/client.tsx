...
export default function CaseStudiesPageClient({ caseStudies }: { caseStudies: CaseStudy[] }) {
  ...
  const filtered =
    active === "All"
      ? caseStudies
      : caseStudies.filter((cs) => cs.categories.includes(active));
    ...
    <main className="min-h-screen">
      ...
      <section className="px-4 max-w-7xl mx-auto pb-24">
                ...
                <div className="flex flex-col flex-1 p-6 gap-4">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <p className="font-dm-sans text-xs text-gray-400 mt-0.5">{cs.client}</p>
                    </div>
        ...
        {filtered.length === 0 && (
          ...
          >
            <p className="font-newsreader italic text-4xl text-gray-200">Nothing here yet.</p>
            <p className="font-dm-sans text-sm text-gray-400 max-w-xs text-center leading-relaxed">
              ...
              <span className="text-lime-500">view all</span> to see what&apos;s live.
            </p>
          </motion.div>
        )}
      </section>
